...
import PersonIndexPage from './PersonIndexPage.jsx';
              ...
              <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav mr-auto">
                  ...
                  <li className="nav-item navSpace">
                    <NavLink className="nav-link" to="/AddPersonPage">Add Person</NavLink>
                  </li>
                  ...
                  <li className="nav-item navSpace">
                  <NavLink to="/PersonIndexPage" className="nav-link">Show-All</NavLink>
                  </li>
                </ul>
              </div>
            </nav>
            <div className="minHeight">
            <Route path="/AddPersonPage" component={AddPersonPage} />
             <Route path="/PersonIndexPage" component={PersonIndexPage} />   
